...
import GooNeuralSection from './goo/GooNeuralSection'

/* ────────────────────────────────────────────────────────────────────────
   MIRDaily — Landing V9 «Goo»
   Copia de la landing clásica (crema #FAF7F4, coral #D4978C, Lexend,
   Material Symbols, bordes oscuros suaves y blobs flotantes) con un
   organismo neuronal 3D interactivo (WebGL) debajo de las features:
   materia blanda que crece con el scroll y se puede estirar y romper.
   ──────────────────────────────────────────────────────────────────────── */
...
export default function LandingV9() {
  ...
  return (
    ...
    <div className="min-h-screen overflow-x-clip bg-[#FAF7F4] text-[#171312]">
      ...
      {/* ─── Goo: organismo neuronal 3D interactivo ─── */}
      <GooNeuralSection />
