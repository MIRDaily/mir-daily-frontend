...
import NeuralSynapsesSection from './NeuralSynapsesSection'

/* ────────────────────────────────────────────────────────────────────────
   MIRDaily — Landing V8 «Sinapsis»
   Copia de la landing clásica (crema #FAF7F4, coral #D4978C, Lexend,
   Material Symbols, bordes oscuros suaves y blobs flotantes) con una
   sección scrollytelling neuronal justo debajo de las features.
   ──────────────────────────────────────────────────────────────────────── */
...
export default function LandingV8() {
  ...
  return (
    // overflow-x-clip (no -hidden): hidden crearía un scroll container y rompería el sticky de Sinapsis
    <div className="min-h-screen overflow-x-clip bg-[#FAF7F4] text-[#171312]">
      ...
      {/* ─── Sinapsis: red neuronal ligada al scroll ─── */}
      <NeuralSynapsesSection />
